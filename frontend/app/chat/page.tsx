      ...
      <main className="min-h-screen bg-slate-950 pt-16 pb-24">
        <section className="relative overflow-hidden border-b border-slate-800">
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-12">
            ...
            Ask questions in plain language. If you uploaded materials for this topic, the chat stays grounded in those files to give more relevant, course-specific help.
            </p>
          </div>
        </section>
